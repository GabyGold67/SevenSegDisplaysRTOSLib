/*
  blinkSampleESP32.ino - Example file to demonstrate SevenSeg-74HC595 class blink related methods
...
const uint8_t dsp1Dio {4}; // Pin A3 of Arduino Nano
// Pin connected to ST_CP of 74HC595 AKA RCLK
const uint8_t dsp1Rclk {2}; // Pin A4 of Arduino Nano
// Pin connected to SH_CP of 74HC595 AKA SCLK
const uint8_t dsp1Sclk {0}; // Pin A5 of Arduino Nano
