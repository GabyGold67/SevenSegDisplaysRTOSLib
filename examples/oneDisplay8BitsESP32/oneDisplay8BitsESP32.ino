/*
  oneDisplay8BitsESP32.ino - Example file to demonstrate SevenSeg74HC595 class use with a single display
...
void loop()
{
  ...
  if ((xTaskGetTickCount() / portTICK_PERIOD_MS - timer) >= testTime)
  {
    ...
    case 15:
      ...
      myLedDisp.noBlink();      
      testResult = myLedDisp.print("You ran");
      break;
    case 16:
      testResult = myLedDisp.print("out oF");
      break;
    case 17:
    ...
    case 28:
      ...
      testResult = myLedDisp.wait(250);
      break;
    case 29:
      break;
    case 30:
      testResult = myLedDisp.wait(150);      
      testResult = myLedDisp.setWaitChar('*');
      break;
    case 31:
      testResult = myLedDisp.setWaitChar('.');
    ...
    case 32:
      ...
      testResult = myLedDisp.print("thatS It");
      break;
    case 33:
